...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainContent" runat="Server">
    ...
    <div class="row">
        <div class="col-md-1"></div>
        <div class="col-md-3">
            <h3 style="font-family: Verdana; text-align: justify; color: cornflowerblue">STD Code: </h3>
        </div>
        <div class="col-md-6">
            <br />
            <asp:TextBox ID="txtSTDCode" runat="server" CssClass="form-control"></asp:TextBox><br />
        </div>
        <div class="col-md-2"></div>
    </div>
